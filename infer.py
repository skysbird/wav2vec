...
#
feature_extractor = AutoFeatureExtractor.from_pretrained("my_awesome_mind_model/checkpoint-1176")
...
model = AutoModelForAudioClassification.from_pretrained("my_awesome_mind_model/checkpoint-1176")
with torch.no_grad():
