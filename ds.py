...
minds = minds.remove_columns(["sentence","up_votes","down_votes","age","gender","accents","locale","segment"])
...
def preprocess_function(examples):
    ...
    for wav_path in examples['path']:
        audio = read_audio_file(f"thai_data/clips/{wav_path}", SAMPLING_RATE) 
